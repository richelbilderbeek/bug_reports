...
-----------|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------
2021-05-08 |Bug report         |[latex-action: Dock build fails: Client.Timeout exceeded while awaiting headers](https://github.com/xu-cheng/latex-action/issues/55)       |No response yet
